...
void insert(int key, int val) {
  ...
  // Lock only the specific bucket with write lock (exclusive)
...
bucket_entry * retrieve(int key) {
  ...
  // Lock only the specific bucket with read lock (allows concurrent readers)
